...
Parameters_sm_ma * Parameters_sm_ma::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_sm_ma * Parameters_sm_ma::getInstance()
{
  if (instance == 0)
    instance = new Parameters_sm_ma(); 

  return instance; 
}

void Parameters_sm_ma::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
...
void Parameters_sm_ma::setIndependentCouplings()
{
  GC_2 = (2. * mdl_ee * mdl_complexi)/3.; 
}
void Parameters_sm_ma::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS); 
  G = 2. * mdl_sqrt__aS * sqrt(M_PI); 
  mdl_G__exp__2 = ((G) * (G)); 
}
void Parameters_sm_ma::setDependentCouplings()
{
  GC_11 = mdl_complexi * G; 
}

// Routines for printing out parameters
void Parameters_sm_ma::printIndependentParameters()
{
  cout <<  "sm_ma model parameters independent of event kinematics:" << endl; 
...
void Parameters_sm_ma::printIndependentCouplings()
{
  cout <<  "sm_ma model couplings independent of event kinematics:" << endl; 
  cout << setw(20) <<  "GC_2 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_2 << endl;
}
void Parameters_sm_ma::printDependentParameters()
{
  cout <<  "sm_ma model parameters dependent on event kinematics:" << endl; 
...
void Parameters_sm_ma::printDependentCouplings()
{
  cout <<  "sm_ma model couplings dependent on event kinematics:" << endl; 
